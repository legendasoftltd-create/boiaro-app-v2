...
import 'book_review_bottom_sheet_model.dart';
export 'book_review_bottom_sheet_model.dart';

class BookReviewBottomSheetWidget extends StatefulWidget {
  const BookReviewBottomSheetWidget({
    super.key,
  ...
  @override
  State<BookReviewBottomSheetWidget> createState() =>
      _BookReviewBottomSheetWidgetState();
}

class _BookReviewBottomSheetWidgetState
    extends State<BookReviewBottomSheetWidget> {
  late BookReviewBottomSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookReviewBottomSheetModel());
                          ...
                          onPressed: () async {
                            if (FFAppState().isLogin == false) {
                              ...
                              if (EbookGroup.addreviewApiCall.success(
                                ...
                                FFAppState().clearGetReviewCacheCache();
