...
import 'payment_success_dialog_model.dart';
export 'payment_success_dialog_model.dart';

class PaymentSuccessDialogWidget extends StatefulWidget {
  ...
  @override
  State<PaymentSuccessDialogWidget> createState() =>
      _PaymentSuccessDialogWidgetState();
}

class _PaymentSuccessDialogWidgetState
    extends State<PaymentSuccessDialogWidget> {
  late PaymentSuccessDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentSuccessDialogModel());
