...
class _AboutPublisherPageWidgetState extends State<AboutPublisherPageWidget> {
  ...
  Future<void> _loadMoreBooks({bool isFirstLoad = false}) async {
    ...
    try {
      final res = await EbookGroup.getbookbypublisherApiCall.call(
      ...
      final newBooks =
          EbookGroup.getbookbypublisherApiCall.bookDetailsList(res.jsonBody) ??
              [];
      final nextCursorVal =
          EbookGroup.getbookbypublisherApiCall.nextCursor(res.jsonBody);
                            ...
                            child: Builder(
                              builder: (context) {
                                if (EbookGroup.getpublisherdetailsApiCall
                                  ...
                                  final publisherList = EbookGroup.getpublisherdetailsApiCall.publisherDetails(
                                    containerGetpublisherdetailsApiResponse.jsonBody,
                                  );
                                  final publisherMap = publisherList != null && publisherList.isNotEmpty
                                      ? Map<String, dynamic>.from(publisherList.first)
                                      : null;
                                  if (publisherMap != null && _followersCount == null) {
                                    _followersCount = publisherMap['followers_count'] as int? ?? 0;
                                    _isFollowing = publisherMap['followed'] == true;
                                  }

                                  final publisherName = (widget.name != null && widget.name!.isNotEmpty)
                                      ? widget.name!
                                      : (publisherMap?['name']?.toString() ?? 'Name');
                                  final imageUrl = (widget.publisherImage != null && widget.publisherImage!.isNotEmpty)
                                      ? widget.publisherImage!
                                      : '${FFAppConstants.imageUrl}${publisherMap?['image'] ?? ""}';
                                                           ...
                                                           Padding(
                                                             ...
                                                             child: TextField(
                                                               ...
                                                               decoration: InputDecoration(
                                                                 hintText: FFLocalizations.of(context).getVariableText(enText: 'Search publisher books...', bnText: 'প্রকাশনীর বই খুঁজুন...'),
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Builder(
                                                                builder: (context) {
                                                                  ...
                                                                  final crossAxisCount = screenWidth < 810.0 ? 3 : screenWidth < 1280.0 ? 4 : 6;
                                                                  ...
                                                                  return GridView.builder(
                                                                    ...
                                                                    itemBuilder: (context, bookDetailsListIndex) {
                                                                      final bookDetailsListItem = bookDetailsList[bookDetailsListIndex];
                                                                      return wrapWithModel(
                                                                        ...
                                                                        child: MainBookComponentWidget(
                                                                          key: Key('Keyu5r_${getJsonField(bookDetailsListItem, r'''$.name''',).toString()}',),
                                                                          imageHeight: 155,
                                                                          ...
                                                                          authorsName: 'By ${getJsonField(bookDetailsListItem, r'''$.author.name''',).toString()}',
                                                                          isFav: functions.checkFavOrNot(
                                                                                  EbookGroup.getFavouriteBookCall.favouriteBookDetailsList(containerGetFavouriteBookResponse.jsonBody,)?.toList(),
                                                                                  getJsonField(bookDetailsListItem, r'''$._id''',).toString()) == true,
                                                                          indicator: (bookDetailsListIndex == _model.popularIndex) && (_model.isPopular == true),
                                                                          isFavAction: () async {
                                                                            if (FFAppState().isLogin == true) {
                                                                              _model.isPopular = true;
                                                                              _model.popularIndex = bookDetailsListIndex;
                                                                              safeSetState(() {});
                                                                              if (functions.checkFavOrNot(
                                                                                ...
                                                                                _model.getPopularDetete = await EbookGroup.removeFavouritebookCall.call(
                                                                                  userId: FFAppState().userId,
                                                                                  token: FFAppState().token,
                                                                                  bookId: getJsonField(bookDetailsListItem, r'''$._id''',).toString(),
                                                                                );
                                                                                safeSetState(() {
                                                                              ...
                                                                              FFAppState().bookId = getJsonField(bookDetailsListItem, r'''$._id''',).toString();
                                                                              FFAppState().update(() {});
                                                                              context.pushNamed(SignInPageWidget.routeName);
                                                                            }
                                                                            safeSetState(() {});
                                                                          },
                                                                          isPurchased: _model.purchasedBookIds.contains(getJsonField(bookDetailsListItem, r'''$._id''',).toString(),),
                                                                          isMainTap: () async {
                                                                            context.pushNamed(BookDetailspageWidget.routeName,
                                                                              queryParameters: {
                                                                                'name': serializeParam(getJsonField(bookDetailsListItem, r'''$.name''',).toString(), ParamType.String,),
                                                                                'price': serializeParam(getJsonField(bookDetailsListItem, r'''$.price''',).toString(), ParamType.String,),
                                                                                'image': serializeParam('${FFAppConstants.bookImagesUrl}${getJsonField(bookDetailsListItem, r'''$.image''',).toString()}', ParamType.String,),
                                                                                'id': serializeParam(getJsonField(bookDetailsListItem, r'''$._id''',).toString(), ParamType.String,),
                                                                              }.withoutNulls,
                                                                            );
                                                                          },
                                                                        ),
