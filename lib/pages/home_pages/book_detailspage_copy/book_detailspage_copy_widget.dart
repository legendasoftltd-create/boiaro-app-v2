...
import 'book_detailspage_copy_model.dart';
export 'book_detailspage_copy_model.dart';

class BookDetailspageCopyWidget extends StatefulWidget {
  const BookDetailspageCopyWidget({
    super.key,
    required this.name,
    required this.image,
    required this.id,
  ...
  static String routeName = 'BookDetailspageCopy';
  static String routePath = '/bookDetailspageCopy';

  @override
  State<BookDetailspageCopyWidget> createState() =>
      _BookDetailspageCopyWidgetState();
}

class _BookDetailspageCopyWidgetState extends State<BookDetailspageCopyWidget> {
  late BookDetailspageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookDetailspageCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final bookDetailspageCopyGetbookdetailsApiResponse = snapshot.data!;
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'By ${EbookGroup.getbookdetailsApiCall.authorName(
                                              bookDetailspageCopyGetbookdetailsApiResponse
                                                  .jsonBody,
                                            )}',
                                            textAlign: TextAlign.center,
                                            maxLines: 1,
