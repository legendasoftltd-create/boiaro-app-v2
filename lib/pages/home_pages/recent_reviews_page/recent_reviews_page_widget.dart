                    ...
                    if (FFAppState().connected == true) {
                      return FutureBuilder<ApiCallResponse>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final containerGetreviewApiResponse = snapshot.data!;
                            ...
                            child: Builder(
                              builder: (context) {
                                if (EbookGroup.getreviewApiCall.success(
                                      containerGetreviewApiResponse.jsonBody,
                                    ) ==
                                    2) {
                                  return Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        valueOrDefault<String>(
                                          EbookGroup.getreviewApiCall.message(
                                  ...
                                  return Builder(
                                    builder: (context) {
                                      ...
                                      return RefreshIndicator(
                                        key: Key('RefreshIndicator_g344jrx4'),
                                        color: FlutterFlowTheme.of(context)
                                            .primary,
                                        onRefresh: () async {
                                          safeSetState(() {
                                            FFAppState()
                                                .clearGetReviewCacheCacheKey(
                                                    _model
