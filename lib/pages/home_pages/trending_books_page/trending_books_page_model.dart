...
import '/index.dart';
import 'dart:async';
import 'trending_books_page_widget.dart' show TrendingBooksPageWidget;
import 'package:flutter/material.dart';

class TrendingBooksPageModel extends FlutterFlowModel<TrendingBooksPageWidget> {
  ///  Local state fields for this page.

  bool? isTrendingBook = false;
  ...
  // Model for NoTrendingBookYet component.
  late NoTrendingBookYetModel noTrendingBookYetModel;
  ...
  void initState(BuildContext context) {
    ...
    noTrendingBookYetModel =
        createModel(context, () => NoTrendingBookYetModel());
  }

  @override
  void dispose() {
    mainBookComponentModels.dispose();
    noTrendingBookYetModel.dispose();
  }
