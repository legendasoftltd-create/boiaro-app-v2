...
class LatestPageWidget extends StatefulWidget {
  ...
  static String routeName = 'LatestPage';
  static String routePath = '/latestPage';
                        ...
                        builder: (context, snapshot) {
                          ...
                          return Container(
                            ...
                            child: FutureBuilder<ApiCallResponse>(
                              future: FFAppState()
                                  .getLatestAllBookCache(
                                requestFn: () =>
                                    EbookGroup.latestAllBookApiCall.call(),
                              )
                                  .then((result) {
                              ...
                              builder: (context, snapshot) {
                                ...
                                final containerLatestAllBookApiResponse =
                                    snapshot.data!;
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      if (EbookGroup.latestAllBookApiCall
                                              .success(
                                            containerLatestAllBookApiResponse
                                                .jsonBody,
                                          ) ==
                                          2) {
                                        return Align(
                                            ...
                                            if (EbookGroup.latestAllBookApiCall
                                              ...
                                              return RefreshIndicator(
                                                ...
                                                onRefresh: () async {
                                                  safeSetState(() {
                                                    FFAppState()
                                                        .clearGetLatestAllBookCacheCache();
