...
class _AboutNarratorPageWidgetState extends State<AboutNarratorPageWidget> {
  ...
  Future<void> _loadMoreBooks({bool isFirstLoad = false}) async {
    ...
    try {
      ...
      final newBooks =
          EbookGroup.getbookbynarratorApiCall.bookDetailsList(res.jsonBody) ??
              [];
      final nextCursorVal =
          EbookGroup.getbookbynarratorApiCall.nextCursor(res.jsonBody);
            ...
            children: [
              wrapWithModel(
                ...
                child: CustomCenterAppbarWidget(
                  title: FFLocalizations.of(context).getVariableText(enText: 'About narrator', bnText: 'কণ্ঠশিল্পী সম্পর্কে'),
                  backIcon: false,
                  addIcon: false,
                  onTapAdd: () async {},
                  shareIcon: true,
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Container(
                                                              ...
                                                              child: Text(FFLocalizations.of(context).getVariableText(enText: 'Narrator', bnText: 'কণ্ঠশিল্পী'),
                                                    ...
                                                    children: [
                                                      Row(
                                                        children: [
                                                          ...
                                                          _buildStatItem(
                                                            context,
                                                            label: FFLocalizations.of(context).getVariableText(enText: 'Listens', bnText: 'শোনা হয়েছে'),
